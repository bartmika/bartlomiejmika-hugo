...
The purpose of this post is to learn how our [basic API server](/posts/2021/how-to-build-an-api-server-in-go-part-1-basic-server/) can read the body of a *request*. In addition, we will learn how to use an easy-to-use *simple database* for beginners called [scribble](https://github.com/sdomino/scribble).
...
3. [How to Build an API Server in Go - Part 3: Postgres Database](/posts/2021/how-to-build-an-api-server-in-go-part-3-postgres-database/)
...
Now onward to the next part of our series: [**Part 3: Postgres Database >>**](/posts/2021/how-to-build-an-api-server-in-go-part-3-postgres-database/).
